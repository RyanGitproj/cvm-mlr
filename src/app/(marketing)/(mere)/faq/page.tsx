...
export const metadata: Metadata = {
  ...
  description:
    "Niveau physique, budget, ce qui est inclus, réservation : les réponses aux questions fréquentes sur les voyages Célébrations Voyages Madagascar et Madagascar Liberty Roots.",
};
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-10 grid gap-12 lg:grid-cols-2">
        <section>
          <SectionHeading titre="Célébrations Voyages Madagascar" />
          <div className="mt-6">
