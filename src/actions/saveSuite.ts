...
/**
 * Enregistre le choix de suite (« rdv » ou « brochure », colonne `suite`)
 * depuis l'écran final. Le lead est identifié par le cookie de session signé
 * HMAC — jamais par un id fourni par le client. Best-effort : l'échec
 * (cookie expiré, base indisponible) ne bloque pas l'affichage du contact
 * direct.
 */
